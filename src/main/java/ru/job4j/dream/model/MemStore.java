...
public class MemStore {
    ...
    private MemStore() {
        ...
        /*candidates.put(1, new Candidate(1, "Tom - Junior Java", "New York"));
        candidates.put(2, new Candidate(2, "Bob - Middle Java", "Moscow"));
        candidates.put(3, new Candidate(3, "Alise - Senior Java", "Samara"));*/
    }
